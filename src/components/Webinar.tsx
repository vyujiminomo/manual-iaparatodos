    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="lg:hidden">
          ...
          {/* Title */}
          <h2 className="font-bebas text-4xl text-ai-black mb-6 leading-tight text-center">
            O Webinar IA Para Todos
          </h2>

          {/* Text */}
          <p className="font-poppins text-lg text-gray-700 leading-relaxed mb-8 text-center">
          ...
          <div className="relative mb-8">
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 mx-4">
