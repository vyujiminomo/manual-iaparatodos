      ...
      <section className="relative py-20 bg-gradient-to-br from-blue-500 via-green-500 to-yellow-400 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6">
          <div className="max-w-5xl mx-auto text-center text-white">
            ...
            <p className="text-xl md:text-2xl mb-4 max-w-3xl mx-auto leading-relaxed text-white/95 font-medium">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {depoimentos.map((depoimento, index) => (
                <Card key={index} className="p-8 bg-white border-0 shadow-lg hover:shadow-2xl transition-all duration-500 rounded-2xl transform hover:-translate-y-2">
                  <Quote className="w-8 h-8 text-blue-500 mb-6" />
                  <p className="text-gray-600 mb-6 text-lg leading-relaxed italic font-light">
                    "{depoimento.texto}"
                  </p>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-16 text-gray-900 tracking-tight">
              O MANIFESTO
            </h2>
            
            <Card className="p-12 bg-gradient-to-br from-yellow-50 via-orange-50 to-yellow-100 border-0 shadow-2xl rounded-3xl">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <Card className="p-12 bg-white shadow-2xl rounded-3xl border-0">
              <div className="space-y-6 text-lg leading-relaxed text-gray-700 font-light">
                ...
                <p className="text-2xl font-bold text-center bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="p-8 bg-gradient-to-br from-blue-50 to-blue-100 border-0 rounded-2xl hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                <CheckCircle className="w-8 h-8 text-blue-600 mb-4" />
                <h3 className="text-lg font-semibold text-gray-900">Como aprender qualquer coisa em segundos</h3>
              </Card>
              <Card className="p-8 bg-gradient-to-br from-green-50 to-green-100 border-0 rounded-2xl hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                <Star className="w-8 h-8 text-green-600 mb-4" />
                <h3 className="text-lg font-semibold text-gray-900">Os '3 passos' pra alcançar a média de 9.5 (rápido)</h3>
              </Card>
              <Card className="p-8 bg-gradient-to-br from-yellow-50 to-yellow-100 border-0 rounded-2xl hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                <Award className="w-8 h-8 text-yellow-600 mb-4" />
                <h3 className="text-lg font-semibold text-gray-900">Os 2 tipos de conhecimento que todo estudante precisa saber</h3>
              </Card>
              <Card className="p-8 bg-gradient-to-br from-purple-50 to-purple-100 border-0 rounded-2xl hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                <Users className="w-8 h-8 text-purple-600 mb-4" />
                <h3 className="text-lg font-semibold text-gray-900">4 técnicas práticas de IA nos estudos</h3>
              </Card>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto text-center">
            <div className="bg-white rounded-3xl shadow-2xl p-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-12 text-gray-900 tracking-tight">
                5 PALESTRAS COMPLETAMENTE GRATUITAS
              </h2>
              
              <div className="bg-gradient-to-r from-red-500 to-red-600 text-white p-10 rounded-3xl mb-12 shadow-xl">
                <h3 className="text-3xl md:text-4xl font-bold mb-6">⚠️ ATENÇÃO: VAGAS LIMITADAS</h3>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-10 mb-12">
                <h3 className="text-3xl font-bold mb-8 text-gray-900">COMO INSCREVER SUA ESCOLA</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="text-center">
                    <div className="bg-blue-500 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                      <span className="text-white font-bold text-xl">1</span>
                    </div>
                    <p className="text-gray-800 font-semibold text-lg">Preencha o formulário</p>
                  </div>
                  <div className="text-center">
                    <div className="bg-blue-500 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                      <span className="text-white font-bold text-xl">2</span>
                    </div>
                    <p className="text-gray-800 font-semibold text-lg">Aguarde nossa análise</p>
                  </div>
                  <div className="text-center">
                    <div className="bg-blue-500 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                      <span className="text-white font-bold text-xl">3</span>
                    </div>
                    <p className="text-gray-800 font-semibold text-lg">Receba a confirmação</p>
                  </div>
                </div>
              </div>
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold text-xl px-16 py-6 rounded-2xl shadow-xl transform hover:scale-105 transition-all duration-300"
              >
