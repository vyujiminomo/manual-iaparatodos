        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 max-w-6xl mx-auto">
            ...
            <div className="w-full lg:w-1/2">
              <div className="relative bg-white rounded-2xl p-8 md:p-10 text-gray-900 shadow-2xl border-2 border-red-500 flex flex-col">
                {/* Badge */}
                <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                  <span className="bg-red-600 text-white text-xs md:text-sm font-bold px-5 py-2 rounded-full shadow-lg whitespace-nowrap">
                    🔥 Mais Escolhido | 75% OFF
                  </span>
                </div>

                <div className="flex flex-col gap-3 mb-6 mt-4 text-center">
                ...
                <Button 
                  ...
                  className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold text-lg md:text-xl px-8 py-7 md:py-8 rounded-xl w-full shadow-[0_0_30px_rgba(250,204,21,0.5)] hover:shadow-[0_0_40px_rgba(250,204,21,0.7)] mb-4"
                >
                  Quero Fazer Parte →
                </Button>
