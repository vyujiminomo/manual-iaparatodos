      ...
      <section className="relative py-24 px-4 bg-white text-black overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12 max-w-6xl mx-auto">
            <div className="bg-gray-50 rounded-3xl p-10 hover:shadow-md transition-shadow duration-300">
              <div className="w-14 h-14 rounded-xl bg-cyan-50 flex items-center justify-center mb-6">
