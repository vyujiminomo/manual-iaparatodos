          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-4 md:p-8 hover:shadow-lg transition-shadow duration-300">
              <h3 className="text-lg md:text-2xl font-bold mb-4 md:mb-6 text-black">
                Dia 1: O que é Inteligência Artificial <span className="text-yellow-500 text-sm md:text-lg block md:inline mt-1 md:mt-0">(11/02/2026 - Quarta, 19h)</span>
              </h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-4 md:p-8 hover:shadow-lg transition-shadow duration-300">
              <h3 className="text-lg md:text-2xl font-bold mb-4 md:mb-6 text-black">
                Dia 2: Como criar Prompts Magnéticos <span className="text-yellow-500 text-sm md:text-lg block md:inline mt-1 md:mt-0">(18/02/2026 - Quarta, 19h)</span>
              </h3>
              <ul className="space-y-2 md:space-y-3 text-gray-700">
                <li className="flex items-start gap-2 md:gap-3">
                  <Check className="text-cyan-400 flex-shrink-0 mt-0.5 md:mt-1" size={18} />
            ...
            <div className="bg-white rounded-lg shadow-md p-4 md:p-8 hover:shadow-lg transition-shadow duration-300">
              <h3 className="text-lg md:text-2xl font-bold mb-4 md:mb-6 text-black">
                Dia 3: As 5 Práticas da IA Generativa <span className="text-yellow-500 text-sm md:text-lg block md:inline mt-1 md:mt-0">(25/02/2026 - Quarta, 19h)</span>
              </h3>
              <ul className="space-y-2 md:space-y-3 text-gray-700">
                <li className="flex items-start gap-2 md:gap-3">
                  <Check className="text-cyan-400 flex-shrink-0 mt-0.5 md:mt-1" size={18} />
