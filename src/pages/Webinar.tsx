          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 text-gray-900 shadow-2xl border-2 border-yellow-400 relative flex flex-col">
              ...
              <Button 
                ...
                className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold text-base md:text-lg px-8 py-6 rounded-lg w-full shadow-[0_0_30px_rgba(250,204,21,0.5)] hover:shadow-[0_0_40px_rgba(250,204,21,0.7)] mb-4"
              >
                <a href="https://pay.hotmart.com/H104969759G?off=xs1ta97u" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
                  Quero Fazer Parte →
                </a>
              </Button>
      ...
      <section className="py-24 px-4 bg-black">
        <div className="container mx-auto max-w-3xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
            Agende uma consultoria <span className="text-teal-400">GRÁTIS</span> com o Vitor
          </h2>
          
          <p className="text-lg md:text-xl text-gray-300 mb-10 leading-relaxed">
            Você ainda tem dúvida se a Imersão é realmente pra você? Por isso, criei algo diferente:
          </p>

          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 md:p-12 mb-8">
            <h3 className="text-2xl md:text-3xl font-bold text-yellow-400 mb-6">
              CONSULTORIA GRÁTIS COMIGO
            </h3>
            <p className="text-gray-300 text-base md:text-lg mb-8 leading-relaxed">
              Se quiser saber como exatamente IA pode te ajudar, testar o 'método único de aprender IA' ou tirar dúvidas:
            </p>
            <a
              href="https://wa.me/5579981255774"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white font-bold text-lg px-10 py-5 rounded-full shadow-[0_0_30px_rgba(34,197,94,0.4)] hover:shadow-[0_0_40px_rgba(34,197,94,0.6)] transition-all duration-300"
            >
              ...
              MANDE MENSAGEM NO WHATSAPP: 79 98125-5774
            </a>
          </div>
        </div>
      </section>
