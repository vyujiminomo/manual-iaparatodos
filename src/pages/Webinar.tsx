      ...
      <section className="relative py-24 px-4 bg-white text-black overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl relative z-10">
          ...
          <div className="flex flex-col gap-6 mb-12 max-w-4xl mx-auto">
            <div className="bg-gray-50 rounded-3xl p-10 hover:shadow-md transition-shadow duration-300 flex items-start gap-6">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-3 text-gray-900">Mentoria em Grupo</h3>
            ...
            <div className="bg-gray-50 rounded-3xl p-10 hover:shadow-md transition-shadow duration-300 flex items-start gap-6">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-3 text-gray-900">Linguagem Simples</h3>
                <p className="text-gray-600 text-base leading-relaxed">
            ...
            <div className="bg-gray-50 rounded-3xl p-10 hover:shadow-md transition-shadow duration-300 flex items-start gap-6">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-3 text-gray-900">Prática Imediata</h3>
                <p className="text-gray-600 text-base leading-relaxed">
