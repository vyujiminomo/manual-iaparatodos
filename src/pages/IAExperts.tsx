...
const IAExperts = () => {
  ...
  useDynamicMeta({
    title: "IA Experts - Vitor Yuji",
    description: "Conheça a IA Experts, a nova experiência de inteligência artificial com Vitor Yuji.",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
            {[
              ...
              },
              {
                day: 4,
                date: "26/08",
                title: "IA pra gestão, marketing e vendas",
                items: [
                  "Como usar IA pra planejar, priorizar e atribuir tarefas",
                  "Os 6Ps para vender qualquer produto (e como turbiná-lo com IA)",
                  "Crie um 'Clone' do seu cliente",
                ],
                accent: "from-fuchsia-400 to-pink-500",
              ...
              },
              {
                day: 5,
                date: "02/09",
                title: "Criando slides/sites em segundos com IA",
                items: [
                  "IA para apresentação em slides",
                  "IA para criar sites",
                  "IA para médicos, advogados, engenheiros, etc",
                ],
                accent: "from-orange-400 to-red-500",
                bg: "bg-orange-400/10",
              },
